...
function MovieCard({ movie }) {
    ...
    return (<> 
        ...
        <div 
        key={m.id}
        className="bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:scale-105 transition duration-300 mt-4">
            <img src={m.image} alt={m.title} className="w-full h-80 object-cover"/>
            ...
            <div className="p-5 mt-4" >
                ...
                <button onClick={() => navigate("/theaters", {state: {movie: m}})}
